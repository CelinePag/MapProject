...
typact_winter = ['BackcountrySki', 'NordicSki', 'AlpineSki', 'IceSkate', 'Snowshoe']
typact_sport = typact_foot + ['BackcountrySki', 'NordicSki', 'Ride', 'Snowshoe']

typact_map = typact_sport + ['AlpineSki', 'EBikeRide', "Swim"]
